...
const DeleteModal = ({show, onClose, onConfirm, onCancel, idKategori}) => {
    ...
    const handleClick = async () => {
        ...
        const res = await axios.delete('/api/kategori/'+idKategori, config)
    ...
    return (
        <>
            <Modal show={show}>
                <h1 className='text-2xl font-bold text-center mb-8'>Apakah anda akan menghapus kategori ini?</h1>
