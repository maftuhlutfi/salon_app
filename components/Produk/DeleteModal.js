...
const DeleteModal = ({show, onClose, onConfirm, onCancel, idProduk}) => {
    ...
    const handleClick = async () => {
        ...
        const res = await axios.delete('/api/produk/'+idProduk, config)
    ...
    return (
        <>
            <Modal show={show}>
                <h1 className='text-2xl font-bold text-center mb-8'>Apakah anda akan menghapus produk ini?</h1>
