...
import AddModal from "../components/AkunAdmin/AddModal";
import { UserContext } from "../components/shared/Context";
import Header from "../components/shared/Header";
import MainContainer from "../components/shared/MainContainer";
import Section from "../components/shared/Section";
import DeleteModal from "../components/AkunAdmin/DeleteModal";
...
const AkunAdmin = () => {
    ...
    useEffect(() => {
        const getPelanggan = async () => {
            ...
            try {
                const res = await axios.get('/api/user/get-admin', config)
    ...
    return (
        <>
            ...
            <MainContainer>
                <Header title='Daftar Admin' subTitle='Kelola semua admin' />
                <Section>
...
export default ProtectedPage(AkunAdmin);